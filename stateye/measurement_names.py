...
MEASUREMENTS = {
    ...
    "zero_level_outer": (float, "y"),
    "one_level_xp": (float, "y"),
    "one_level_4140": (float, "y"),
    "one_level_8180": (float, "y"),
    "two_level_xp": (float, "y"),
    "two_level_4140": (float, "y"),
    "two_level_8180": (float, "y"),
    "three_level_xp": (float, "y"),
    "three_level_4140": (float, "y"),
    "three_level_8180": (float, "y"),
    "three_level_outer": (float, "y"),
    "average": (float, "y"),
...
MEASUREMENT_COUNTS = {
    "threshold": (int, "y"),
    "threshold_lower": (int, "y"),
    "threshold_upper": (int, "y"),
    "zero_level_xp": (int, "y"),
    "zero_level_4140": (int, "y"),
    "zero_level_8180": (int, "y"),
    "zero_level_outer": (int, "y"),
    "one_level_xp": (int, "y"),
    "one_level_4140": (int, "y"),
    "one_level_8180": (int, "y"),
    "two_level_xp": (int, "y"),
    "two_level_4140": (int, "y"),
    "two_level_8180": (int, "y"),
    "three_level_xp": (int, "y"),
    "three_level_4140": (int, "y"),
    "three_level_8180": (int, "y"),
    "three_level_outer": (int, "y"),
    "extinction_ratio_xp": (int, None),
    "extinction_ratio_4140": (int, None),
    "extinction_ratio_8180": (int, None),
    "extinction_ratio_outer": (int, None),
    "oma_xp": (int, "y"),
    "oma_8180": (int, "y"),
    "oma_4140": (int, "y"),
    "oma_outer": (int, "y"),
